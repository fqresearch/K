...
import fq
from fq.lib.curve.ttypes import *
...
[Yupi keluar] = Mengeluarkan bot utama dari semua grup
...
#-----------------------------------------------
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Dadah semuanya","dadah semuanya"]:
              if msg.from_ in admin:
                if msg.toType == 2:
    ...
    #-------------Fungsi Tag All Start---------------#
            elif msg.text in ["ikutan sini","Nongol dong","Hoii","Oi"]:
...
#-----------------------------------------------
                ...
                cl.sendText(msg.to,"kenape njer 􀜁􀅔Har Har􏿿")
            elif msg.text in ["bot apa sih ini gajelas","Gajelas","gjls","gajelas"]:
            ...
            elif msg.text in ["Bacot pik","bacot pik"]:
                cl.sendText(msg.to,"kenapa pacar aku 􀄃􀇂Cony happy􏿿")
#-----------------------------------------------
      ...
      #-------------Fungsi Balesan Respon Finish---------------------#
       ...
       #-------------Fungsi Speedbot Start---------------------#
            elif msg.text in ["Speedbot","Speed", "sp", "Sp"]:
                start = time.time()
...
#-----------------------------------------------
      ...
      #-------------Fungsi Bannlist Finish------------------#  
            ...
            elif msg.text.lower() == 'keluar semuanya':
			  if msg.from_ in admsa:
				gid = cl.getGroupIdsJoined()
