...
[Dadah anin] = Mengeluarkan bot utama
[Anin keluar] = Mengeluarkan bot utama dari semua grup
...
def bot(op):
    try:
        ...
        if op.type == 17:
            ...
            cb = Message()
            cb.to = op.param1
            cb.text = "Hai kak " + cl.getContact(op.param2).displayName + ", Selamat datang di grup kami 􀄃􀆏moon wink􏿿" + group.name + "semoga betah ya :)"
            cl.sendMessage(cb)
